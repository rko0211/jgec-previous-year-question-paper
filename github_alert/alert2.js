class GitHubStarReminder {
  constructor(options = {}) {
    ...
    // Inject CSS when first initialized
    this.injectCSS();
    this.init();
  }
  ...
  createAlert() {
    ...
    alertBox.innerHTML = `
            ...
            <div class="github-alert-dont-show" style="margin-top:20px; text-align:left;">
  ...
  closeAlert() {
    if (document.getElementById('githubAlertDontShow').checked) {
